...
// label : teks tampil
// icon  : emoji
// href  : path relatif dari folder /pages/
...
const NAV_MENU = [
  {
    group: 'Operasional',
    items: [
      { key: 'order',        label: 'Order Masuk',    icon: '📝', href: 'order.html' },
      { key: 'spk',           label: 'SPK',             icon: '🖨️', href: 'spk.html' },
      { key: 'log_produksi',  label: 'Log Produksi',    icon: '📊', href: 'log_produksi.html' },
      { key: 'stok_bj',       label: 'Stok BJ',         icon: '📦', href: 'stok_bj.html' },
      { key: 'pengiriman',    label: 'Pengiriman',      icon: '🚚', href: 'pengiriman.html' },
      { key: 'retur',         label: 'Retur',           icon: '↩️', href: 'retur.html' },
    ]
  },
  {
    group: 'Keuangan',
    items: [
      { key: 'piutang',   label: 'Piutang & Faktur', icon: '🧾', href: '#', soon: true },
      { key: 'kas_kecil', label: 'Kas Kecil',         icon: '💵', href: '#', soon: true },
      { key: 'bank',      label: 'Bank',              icon: '🏦', href: '#', soon: true },
      { key: 'pembelian', label: 'Pembelian',         icon: '🛒', href: '#', soon: true },
  ...
  },
  {
    group: 'Master',
    items: [
      { key: 'pelanggan', label: 'Pelanggan', icon: '🏢', href: 'pelanggan.html' },
      { key: 'item',      label: 'Item',       icon: '📦', href: 'item.html' },
      { key: 'bahan',     label: 'Bahan',      icon: '🧱', href: 'bahan.html' },
      { key: 'tinta',     label: 'Tinta',      icon: '🎨', href: 'tinta.html' },
      { key: 'bom',       label: 'BOM',        icon: '📋', href: 'bom.html' },
      { key: 'operator',  label: 'Operator',   icon: '👤', href: 'operator.html' },
    ]
  },
  {
    group: 'Sistem',
    items: [
      { key: 'user_management', label: 'User Management', icon: '👥', href: 'user_management.html', role: ['DIREKTUR'] },
    ]
  }
];
